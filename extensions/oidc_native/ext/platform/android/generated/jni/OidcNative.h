...
class COidcNativeBase : public MethodExecutorJni
{
protected:
    DEFINE_LOGCLASS;
...
public:
    ...
    COidcNativeBase(const rho::String& id)
        : MethodExecutorJni(), m_id(id)
        {}
    virtual ~COidcNativeBase() {}
};

template <typename T>
class COidcNativeProxy : public COidcNativeBase
{
public:
    COidcNativeProxy(const rho::String& id)
        : COidcNativeBase(id)
        {}
    virtual ~COidcNativeProxy() {}
